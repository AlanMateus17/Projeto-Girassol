...
function removerFormatacaoCPF(cpf) {
    ...
    // A expressao [^\d] busca por quealquer caractere que nao seja um digito.
...
$(document).ready(function () {
    ...
    $.validator.addMethod("rgValido", function (value, element) {
        ...
        return this.optional(element) || (value.length >= 7 && value.length <= 12);
    },
        // Mensagem de erro que sera exibida se a validaçao falhar.
        "Por favor, insira um RG válido (7 a 12 dígitos).");
